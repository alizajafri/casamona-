...
<?php } ?>
	...
	<div class="<?php echo esc_html( $container ); ?>">
		...
		$args = array( 'post_type' => 'listing',
				...
				$current_sort = isset( $_GET['orderby'] ) ? esc_attr( $_GET['orderby'] ) : 'date';	
				switch( $current_sort ) {
					case 'date':
						$args['orderby']  = array( 
	...
	<?php $field_key_gallary = get_field_object('field_58d366980a2bd', get_the_ID()); ?>
	  ...
	  <div class="listing col-md-4">
		<div class="post-thumb"><a class="text-center" href="<?php echo get_the_permalink(); ?>?offer=<?php echo $_GET['offer']; ?>&location=<?php echo $_GET['location']; ?>&min=<?php echo $_GET['min']; ?>&max=<?php echo $_GET['max']; ?>&bedrooms=<?php echo $_GET['bedrooms']; ?>&listing-type=<?php echo $_GET['listing-type']; ?>">
		<?php 
