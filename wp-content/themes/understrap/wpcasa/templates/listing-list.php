...
<?php } ?>
	...
	echo '<div class="listing-list wpsight-listings">';
	...
	while ( $the_query->have_posts() ) : $the_query->the_post(); ?>
	  ...
	  <?php $field_key_gallary = get_field_object('field_58d366980a2bd', get_the_ID()); ?>
		...
		<div class="slide-content col-md-8 pull-right">
			...
			<div class="col-md-12 post-meta-data pull-left"><span class="homes pull-left"><?php echo get_post_meta($post_id,'_details_4',true); ?> m2</span><span class="bed pull-left"><?php if(get_post_meta($post_id,'_details_1',true)!=''){echo get_post_meta($post_id,'_details_1',true);} else {echo '0';} ?> beds</span><span class="bath pull-left"><?php if(get_post_meta($post_id,'_details_2',true)!=''){echo get_post_meta($post_id,'_details_2',true);} else {echo '0';} ?> baths</span><span class="read-more pull-left"><a class="text-center" href="<?php echo get_permalink(); ?>">More Info</a></span></div>
		</div>
	  </div>
	<?php endwhile;
	endif; echo '</div>'; ?>
