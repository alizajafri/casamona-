...
gulp.task('sass', function () {
    var stream = [  
				...
				basePaths.dev +'./css/jquery.nouislider.min.css' , 
				basePaths.dev +'./css/jquery.bxslider.css', 
...
gulp.task('scripts', function() {
    var scripts = [
		...
		basePaths.dev + 'js/jquery.megaselectlist.js',
		basePaths.dev + 'js/jquery.nouislider.all.min.js',
		basePaths.dev + 'js/jquery.bxslider.js',
...
// Copy Tether JS files
    gulp.src(basePaths.node + 'tether/dist/js/*.js')
        .pipe(gulp.dest(basePaths.dev + '/js'));
// Copy multiselect JS files
    gulp.src(basePaths.node + 'multiselect/dist/js/*.js')
        .pipe(gulp.dest(basePaths.dev + '/js'));
// Copy nouislider JS files
    gulp.src(basePaths.node + 'jquery.nouislider.all.min/dist/js/*.js')
        .pipe(gulp.dest(basePaths.dev + '/js'));	
// Copy megaselect JS files
    gulp.src(basePaths.node + 'jquery.megaselectlist/dist/js/*.js')
        .pipe(gulp.dest(basePaths.dev + '/js'));	
// Copy Tether CSS files
    gulp.src(basePaths.node + 'tether/dist/css/*.css')
        .pipe(gulp.dest(basePaths.dev + '/css'));		
// Copy nouislider CSS files
    gulp.src(basePaths.node + 'jquery.nouislider.min/dist/css/*.css')
        .pipe(gulp.dest(basePaths.dev + '/css'));
// Copy boxslider CSS files
    gulp.src(basePaths.node + 'jquery.bxslider/dist/css/*.css')
        .pipe(gulp.dest(basePaths.dev + '/css'));
    return stream;
});
